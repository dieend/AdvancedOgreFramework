...
void PauseState::enter()
{
	...
	OgreFramework::getSingletonPtr()->m_pTrayMgr->createButton(OgreBites::TL_CENTER, "BackToSinbadBtn", "Return to SinbadState", 250);
...
void PauseState::buttonHit(OgreBites::Button *button)
{
	...
	{
		popAllAndPushAppState(findByName("SinbadState"));
        m_bQuit = true;
	}
